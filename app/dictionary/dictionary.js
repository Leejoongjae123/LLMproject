export const dictionary = {
  'sidebar':{
    ...
    'select': {
      ...
      'step4':{
        'korean': '보고서 작성',
        'english': 'Write Report',
      },
      'subtitle':{
        'korean': '기업이 공시할 보고서 기준을 선택하실 수 있습니다.',
        'english': 'You can select the standard of the report that the company will disclose.',
      },
      'previous':{
        'korean': '이전',
        'english': 'Previous',
      ...
      'tooltipContent1':{
        'korean': '글로벌 기준서인 ISSB 보고서는 지속가능성 관련 재무정보 공시에 대한 일반요구사항(S1) 및 기후 관련 공시(S2) 등을 다루는 보고서',
        'english': 'The ISSB report is a report that covers general requirements (S1) and climate-related disclosure (S2) for sustainability-related financial information disclosure.',
      },
      'tooltipContent2':{
        'korean': '한국의 지속가능성 공시 기준서인 KSSB 보고서는 일반사항(제1호), 기후 관련 공시사항(제2호)과 추가공시(제101호) 등을 다루는 보고서',
        'english': 'The KSSB report is a report that covers general requirements (Article 1), climate-related disclosure (Article 2), and additional disclosure (Article 101).',
      },
      'inProcess':{
        'korean': '개발중',
        'english': 'In Process',
    ...
    'upload':{
      ...
      'dragInstruction':{
        'korean': '파일을 드래그해주시거나 PC에서 직접 선택해주세요',
        'english': 'Drag or select files from your PC',
      },
      'fileTypeInstruction':{
        'korean': '확장자:PDF, DOCX, XLSX, XLS, PPTX, PPT, HWP, HWPX, CSV (최대 50MB)',
        'english': 'File Type: PDF, DOCX, XLSX, XLS, PPTX, PPT, HWP, HWPX, CSV (Max. 50MB)',
      },
      'basicFileList':{
        'korean': '기본 파일리스트',
        'english': 'Basic File List',
      },
      'header1':{
        'korean': '파일명',
        'english': 'File Name',
      ...
      "AIStudyComplete":{
        'korean': 'AI 학습 완료',
        'english': 'AI Study Complete',
      },
      "AIStudyProcessing":{
        'korean': 'AI 학습 중',
        'english': 'AI Study Processing',
      },
      "uploadInstruction1":{
        'korean': '업로드 하는 파일이 50MB를 초과할 경우 마크스폰 컨설턴트에게 문의 주세요',
        'english': 'If the file you upload exceeds 50MB, please contact MarkSpot consultant.',
      },
      'uploadInstruction2':{
        'korean': '첨부된 파일은 AI 초안을 완성하는데 활용돼요. 공시자료 파일을 업로드해주세요.',
        'english': 'The attached file will be used to generate an AI draft. Please upload the disclosure material file.',
      },
      'uploadInstruction3':{
        'korean': '업로드된 데이터를 바탕으로 문장이 생성되며, 좋은 답변을 받기 위한 파트별 추천자료를 안내 드립니다.',
        'english': 'The data uploaded will be used to generate sentences, and we will guide you on the recommended materials for each part to receive good answers.',
      },
      'uploadInstruction4':{
        'korean': '다만, 대외비 문서나 민감한 자료는 업로드를 삼가해 주세요.',
    ...
    'guide':{
      'completeInstruction1':{
        "korean":'IFRS S2 보고서',
        "english":'IFRS S2 Report',
      },
      'completeInstruction2':{
        "korean":'재시도',
        "english":'Retry',
      },
      'completeInstruction3':{
        "korean":'확인',
        "english":'Confirm',
      },
      'completeInstruction4':{
        "korean":'AI 초안 생성 완료',
        "english":'AI Draft Complete',
      },
      "AIManager":{
        "korean":'AI 매니저',
        "english":'AI Manager',
      ...
      "metric":{
        'korean': '지표 및 목표',
        'english': 'Metric Management',
      },
      "governance1":{
        'korean': '기후 관련 위험 및 기회에 관한 이사회 차원의 감독',
        'english': 'Board-Level Oversight of Climate-Related Risks and Opportunities',
      },
      'governance2':{
        'korean': '기후 관련 위험 및 기회에 관한 경영진의 역할',
        'english': 'Role of Management in Climate-Related Risks and Opportunities',
      },
      'metric1':{
        'korean': '기후 관련 지표',
        'english': 'Climate-Related Metrics',
      },
      'AIManagerInstruction1':{
        'korean': '생성된 초안 박스별로 EDK AI와 협업하실 수 있어요',
        'english': 'You can collaborate with EDK AI on each generated draft box.',
      },
      'AIManagerInstruction2':{
        'korean': '퀵 AI 버튼과 대화를 통해서 초안을 수정해 보세요!',
        'english': 'Use the Quick AI button and conversation to modify the draft!',
      },
      'write1':{
        'korean': '자세히 쓰기',
        'english': 'Expand Text',
      ...
      'write2':{
        'korean': '간결하게 쓰기',
        'english': 'Condense Text',
      },
      'write3':{
        'korean': '윤문하기(paraphrase)',
        'english': 'Paraphrase',
      },
      'writeInstruction1':{
        'korean': 'AI 매니저에게 요청을 직접 입력하실 수도 있어요',
        'english': 'You can directly enter requests to the AI Manager',
      },
      'writeInstruction2':{
        'korean': '기후 관련 이사회의 책임범위를 보다 구체적으로 작성해줘',
        'english': "Detail the board's climate responsibilities",
      },
      'writeInstruction3':{
        'korean': '경영진이 기후 리스크 평가를 어떻게 하고 있는지 내용을 추가해줘',
        'english': "Add how management assesses climate risks",
      },
      "checkReference":{
        'korean': '출처(Reference) 확인하기',
        'english': 'View reference',
      },
      'askAnything':{
        'korean': 'EDK AI 매니저에게 무엇이든 물어보세요',
        'english': 'Ask EDK AI Manager',
      },
      'changeData':{
        'korean': '데이터 변경',
        'english': 'Change Data',
      ...
      'smallTitle1':{
        "korean":"이사회의 역할 및 책임",
        "english":"Role and Responsibilities of the Board",
      },
      'smallTitle2':{
        "korean":"관리 감독 체계",
        "english":"Governance and Oversight Structure",
      },
      'smallTitle3':{
        "korean":"경영진의 역할 및 감독 프로세스",
        "english":"Climate-Related Risk and Opportunity Management Process",
      },
      'smallTitle4':{
        "korean":"온실가스 배출량",
      ...
      'AIDiagnosisInstructionUpper1':{
        'korean':'<strong>기후 관련 위험과 기회에 대한 책임과 역할</strong>이 명확히 정의된 <strong>의사결정기구의 정보 및 운영 규정</strong>이 명확히 설명되어야 해요. 또한, <strong>기후변화 대응을 위한 기업의 전문성과 역량 강화</strong> 노력이 어떤지 작성해 주세요.',
        'english':'<strong>Responsibilities and roles for climate-related risks and opportunities</strong> must be clearly defined. <strong>Information and operational regulations</strong> of the decision-making body must be clearly described. In addition, <strong>efforts to enhance corporate expertise and capabilities to respond to climate change</strong> should be described.',
      },
      'AIDiagnosisInstructionUpper2':{
        'korean':'<strong>기후 관련 위험 및 기회 관련 정보</strong>를 제공하는 <strong>정기적인 보고 체계</strong>가 어떻게 구축되어 있는지 설명해 주세요. 또한 이러한 체계가 <strong>조직 내 의사결정에 어떻게 기여하는지</strong> 구체적으로 작성되면 좋습니다.<br/><br/> <strong>투자 및 경영 계획에 기후 리스크와 기회를 반영하기 위한 역할과 책임</strong>이 어떻게 설정되어 있는지, <strong>경영 관련 의사결정 시 기후 요소가 어떻게 연계</strong>되는지 명확히 설명해 주세요.<br/><br/> <strong>기후 관련 목표 설정과 이를 모니터링하는 체계</strong>가 잘 구축되어 있는지, <strong>성과 기반 보상 정책</strong>에 이러한 목표가 반영되고 있는지 작성해 주세요',
        'english':"<strong>Please explain how a <em>regular reporting system</em> for providing information related to <em>climate risks and opportunities</em> is established.</strong> Additionally, it would be helpful to detail <strong>how this system contributes to organizational decision-making</strong>.<br/><br/> <strong>Describe how <em>roles and responsibilities</em> are defined</strong> to incorporate climate risks and opportunities into investment and management plans, and clearly explain <strong>how climate factors are integrated into management-related decision-making</strong>.<br/><br/> <strong>Provide details on whether a <em>climate-related goal-setting and monitoring system</em> is well established</strong> and whether these goals are incorporated into <strong>performance-based compensation policies</strong>.",
      },
      'AIDiagnosisInstructionUpper3':{
        'korean':'<strong>기후 변화 대응을 위한 경영진의 보고 및 감독 프로세스</strong>가 어떻게 마련되어 있는지 작성해 주세요. 특히, <strong>기후 관련 위험 및 기회 대응을 위해 전담 조직</strong>이 지정되어 있는지와 <strong>정기적인 보고 체계가 어떻게 운영</strong>되는지 설명해 주시면 좋아요.<br/><br/> 또한, <strong>전사 차원의 리스크 관리 체계에 기후 관련 리스크가 어떻게 통합</strong>되어 있는지, <strong>내부 통제 시스템을 통해 기후 리스크를 효과적으로 관리하고 있는지</strong> 구체적으로 작성해 주세요.',
        'english':'<strong>Please describe how the <em>reporting and oversight process for addressing climate change</em> by the management is established.</strong> In particular, it would be helpful to explain whether a <strong>dedicated organization for responding to climate-related risks and opportunities</strong> has been designated and <strong>how the regular reporting system operates.</strong><br/><br/>Additionally, please provide specific details on <strong>how climate-related risks are integrated into the enterprise-wide risk management system</strong> and <strong>whether climate risks are effectively managed through the internal control system.</strong>',
      },
      'writeInstruction1':{
      ...
      'writeInstruction2':{
        'korean':'방금 작성한 문장 내용과 데이터 출처를 그대로 유지하면서, 문장을 조금 더 짧게 작성해줘.',
