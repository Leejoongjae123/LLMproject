export const sampleText = [
  {
    ...
    text: "가",
    contents1:
      '<p><strong>의사결정기구 및 책임에 관한 정책</strong></p><br/><p><strong style="color: #F25B2B">[기업명]</strong>의 이사회는 기업의 최상위 의사결정기구로서 기후변화 관련 위험 및 기회가 회사의 장기 사업 전략에 반영돼 있는지를 관리·감독하는 기능을 수행하며, 이사회 내 <strong style="color: #F25B2B">[000위원회]</strong>를 두어 기후변화 대응 전략의 수립 및 이행을 지속적으로 점검하고 있습니다.  <strong style="color: #F25B2B">[000위원회]</strong>의 설치 목적, 조직, 운영, 권한 및 책임에 대해서 위원회 규정을 통해 서면으로 마련하였습니다.</p>',
    contents2: "",
    link1_1: "",
    link1_2: "",
    link1_3: "",
...

  {
    ...
    key: "domestic",
    text: "가",
    contents1: `<p><strong>위험 및 기회에 관한 관리·감독 기구</strong></p><br/> <p>연결회사의 기후 변화 관련 위험 및 기회를 감독할 책임이 있는 최상위 의사결정기구는 LG유플러스 이사회 산하의 ESG위원회입니다. ESG위원회는 지속가능경영 관련 최고 심의기구로서 ESG 분야의 기본 정책과 전략을 수립하고 중ㆍ장기 목표 등을 심의하는 역할을 합니다. ESG위원회는 반기 1회 이상 개최를 원칙으로 하되, 필요에 따라 수시로 개최될 수 있습니다. 지배기업 이사회의 ESG위원회에 대한 위임사항과 의무사항, 직무기술 등에 대한 내용은 이사회 규정, ESG위원회 규정, 내규 등에 규정하고 있습니다.</p><p>ESG위원회는 기후 변화를 포함한 지속가능성 관련 최고 의사결정 기구로서 지속가능경영에 대한 추진 전략 및 정책을 승인하고, 이행에 대한 관리·감독 권한을 보유합니다. ESG위원회 규정 제10조 부의사항에서 동 위원회에서 부의할 사항을 명시하고 있으며, 안건 심의를 위하여 필요한 경우 관련 자료의 제출 및 보고를 회사에 요청할 수 있습니다.</p>
    <br/>
    <p>보고서명: [LG유플러스] 2023 지속가능성 관련 IFRS S1·S2 보고서(Special Report)</p>
    <p>페이지: p.11-12 </p>
    `,
    contents2: `<p><strong>의사결정기구 및 책임에 관한 정책</strong></p><br/><p>이사회 산하 지속가능경영위원회는 기후변화를 포함한 지속가능성 관련 의사결정기구로서 KT&amp;G 및 연결 대상 종속회사의 지속가능경영에 대한 추진 전략을 수립하고 정책의 승인 및 이행에 대한 관리·감독 권한을 보유하고 있습니다. 지속가능경영위원회 설치 이전에는 전체 이사회에서 중장기 환경경영전략 수립을 검토한 바 있으며(2021년 4월), 2023년 4월에는 이사회 산하 지속가능경영위원회에서 기후변화 시나리오 기반의 리스크와 기회를 검토하고 2023년 8월에는 그룹차원의 기후변화 대응 중장기 목표를 결의하였습니다.</p><p>아울러 KT&amp;G는 사외이사로만 구성된 감사위원회를 통해 전사 리스크 관리 현황을 점검하고 있습니다. 2022년에는 기후변화 이슈를 포함한 ESG 경영 추진 현황 점검을 감사위원회 산하 독립적인 조직인 ‘감사단’에서 수행하고 그 결과를 감사위원회에 보고하였습니다.</p><p>이를 통해 기후 관련 이슈를 포함한 ESG 이슈가 KT&amp;G의 전략수립, 지배구조, 그리고 기업 책임 전반에 필수적으로 반영될 수 있도록 노력하고 있습니다. 기후 관련 위험 및 기회를 감독할 책임이 있는 경영진의 보상정책은 ‘지표 및 목표 문단1. (7) 보상(경영진)’을 참조하시기 바랍니다.</p>
      <br/>
      <p>보고서명: [KT&G] 2023 KT&G 통합보고서</p>
      <p>페이지: p.51</p>
      `,
    link1_1:
      "https://drive.google.com/file/d/1V3BrFWX_ytjqoMesw3QjWAa_IY96u8pK/view?usp=drive_link",
    link1_2:
      "https://drive.google.com/file/d/1fqXifB7qUcg4RhK1m8sZCBNrcKJeu9tE/view?usp=drive_link",
    link1_3:
  ...
  },
  {
    ...
    text: "나",
    contents1:
      '<p><strong>관리·감독을 위한 역량 판단 및 개발</strong></p><br/><p><strong style="color: #F25B2B">[기업명]</strong>은 기후 관련 위험과 기회에 효과적으로 대응하기 위해 이사회의 전문성 강화에 힘쓰고 있습니다. 신임 이사 후보 선정 시 기후 관련 위험 및 기회에 대응하기 위한 전략을 감독할 수 있는 적절한 역량을 갖추었는지 판단하는 절차로써 지배기업의 이사회 평가지표인 이사회 역 량지표(Board Skills Matrix)를 활용하고 있습니다. <strong style="color: #F25B2B">[기업명]</strong>은 <strong style="color: #F25B2B">[000]</strong> 분야의 전문성을 갖춘 <strong style="color: #F25B2B">[000]</strong>님을 사외이사로 선임하여 이사회의 전문성을 강화했습니다. <strong style="color: #F25B2B">[000]</strong>님은 <strong style="color: #F25B2B">[경력 소개]</strong>를 통해 쌓은 풍부한 경험을 바탕으로 기후 변화 관련 의사결정에 기여하고 있습니다.또한 기후 변화 관련 대응 관리 · 감독 역량을 향상하기 위한 외부 전문가 자문을 포함한 사내·사외 다양한 교육을 제공하고 있습니다. </p>',
    contents2: "",
    link1_1: "",
    link1_2: "",
    link1_3: "",
...

  {
    ...
    text: "나",
    contents1: `
    <h1><strong>위험 및 기회 관리·감독을 위한 역량 판단 및 개발</strong></h1>
    <br/>
    <p>연결회사의 지배기업은 신임 이사 후보 선정 시 해당 기준을 갖추었는지 판단하는 절차로써 지배기업의 이사회 평가지표인 이사회 역량지표(Board Skills Matrix)를 활용하고 있습니다. BSM의 5개의 평가항목 중, ESG 역량 지표 내에 지속가능성 관련 역량을 평가할 수 있는 요소를 포함함으로써 기후 변화 관련 전문성을 보유한 이사가 선임되도록 하고 있습니다.</p>
    <p>지속가능성 관련 전문성을 보유한 이사는 연결회사의 지속가능성 관련 의사결정 과정에서 기후 변화 관련 사안에 대해 적극적으로 의견을 개진합니다.</p>
    <br/>
    <p>보고서명: [LG유플러스] 2023 지속가능성 관련 IFRS S1·S2 보고서(Special Report)</p>
    <p>페이지: p.12-13</p>
    `,
    contents2: `
     <h1><strong>관리·감독을 위한 역량 판단 및 개발</strong></h1>
     <br/>
    <p>KT&amp;G는 환경경영에 대한 이해 및 리더십, 기후 관련 국제 사회 요구와 에너지·온실가스 관련 법/규정에 대한 충분한 이해도를 바탕으로 기후 관련 위험 및 기회에 대응하기 위한 전략을 감독할 수 있는 적절한 역량을 보유하고 있는 것으로 판단하고 있습니다. 해당 기준 충족 여부 판단 절차로 신임 이사 후보 선정 시, 이사회 평가지표인 ‘KT&amp;G 이사회 역량지표(Board Skills Matrix)’를 활용하고 있습니다.</p>

    <p>BSM의 8개의 평가항목 중, Sustainability 역량에 대한 정의는 ‘회사의 지속가능한 성장을 돕고, ESG 관련 위험 및 기회의 관리감독에 기여하는 것’을 말하며, KT&amp;G는 이사 후보 평가에 이를 반영함으로써 이사가 지속가능경영 관련 적절한 경험 및 전문성을 보유하고 있는지 판단하고 있습니다.</p>
...

  {
    ...
    text: "다",
    contents1: `
    <h1><strong>의사결정기구에 대한 보고 방법 및 빈도</strong></h1>
    <br/>
    <p>ESG위원회가 기후 변화 관련 위험과 기회를 관리·감독하기 위해 필요한 정보는 주로 지배기업 내 ESG정책팀으로부터 제공받고 있습
니다. 또한 ESG위원회 개최 시, 안건 담당부서는 ESG위원회가 의안내용을 충분히 이해하고 판단할 수 있도록 사전 보고와 각종 자료
제공을 통해 이해를 돕고 있습니다. ESG위원회는 필요한 경우에 외부전문가의 자문을 받을 수 있습니다. ESG위원회는 동 위원회 내
에서 심의 · 의결한 결과를 최종적으로 이사회에 보고하고 있습니다.</p>
    <br/>
    <p>보고서명: [LG유플러스] 2023 지속가능성 관련 IFRS S1·S2 보고서(Special Report)</p>
    <p>페이지: p.13</p>
    `,
    contents2: `
     <h1><strong>위험 및 기회 관련 정보 획득 방법 및 빈도</strong></h1>
     <br/>
    <p>지속가능경영위원회는 기후 관련 위험과 기회를 관리·감독하기 위해 필요한 정보를 주로 KT&G 내 전략부문 ESG경영실로부터 제공받고 있습니다. 또한 지속가능경영위원회 개최 시, ESG경영실은 지속가능경영위원회가 의안내용을 충분히 이해하고 판단할 수 있도록 사전보고와 각종 자료 제공을 통해 이해를 돕고 있습니다. 지속가능경영위원회는 필요한 경우에 회사의 비용으로 외부전문가의 자문을 받을 수 있습니다.</p>
